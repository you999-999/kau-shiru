...
export const REGIONS = {
  北海道: {
    prefectures: {
      '北海道': ['札幌市', '旭川市', '函館市', '釧路市', '帯広市', '北見市', '小樽市', '苫小牧市', '江別市', '千歳市', '室蘭市', '岩見沢市', '網走市', '留萌市', '名寄市', '根室市', '富良野市', '士別市', '稚内市', '紋別市', '美唄市', '芦別市', '赤平市', '三笠市', '滝川市', '砂川市', '歌志内市', '深川市', '夕張市', '恵庭市', '伊達市', '北広島市', '石狩市', '北斗市']
    }
  },
  東北: {
    prefectures: {
  ...
  中部: {
    prefectures: {
      ...
      '岐阜県': ['岐阜市', '大垣市', '高山市', '多治見市', '関市', '中津川市', '美濃市', '瑞浪市', '羽島市', '恵那市', '美濃加茂市', '土岐市', '各務原市', '可児市', '美濃加茂市', '可児市', '山県市', '瑞穂市', '本巣市', '郡上市', '下呂市', '海津市'],
  ...
  近畿: {
    prefectures: {
      ...
      '奈良県': ['奈良市', '大和高田市', '大和郡山市', '天理市', '橿原市', '桜井市', '五條市', '御所市', '生駒市', '香芝市', '葛城市', '宇陀市', '山添村', '平群町', '三郷町', '斑鳩町', '安堵町', '川西町', '三宅町', '田原本町', '曽爾村', '御杖村', '高取町', '明日香村', '上牧町', '王寺町', '広陵町', '河合町', '吉野町', '大淀町', '下市町', '黒滝村', '天川村', '野迫川村', '十津川村', '上北山村', '川上村', '東吉野村'],
...
// 地域の大項目一覧
export const REGION_BIG_OPTIONS = Object.keys(REGIONS) as Array<keyof typeof REGIONS>

// 都道府県一覧を取得
export function getPrefectures(regionBig: keyof typeof REGIONS): string[] {
  return Object.keys(REGIONS[regionBig]?.prefectures || {})
}
...
export const REGION_DEFAULTS: Record<keyof typeof REGIONS, { prefecture: string; city: string }> = {
  北海道: { prefecture: '北海道', city: '札幌市' },
  東北: { prefecture: '宮城県', city: '仙台市' },
  関東: { prefecture: '東京都', city: '千代田区' }, // 東京都は特別区なので、代表として千代田区
  中部: { prefecture: '愛知県', city: '名古屋市' },
  近畿: { prefecture: '大阪府', city: '大阪市' },
  中国: { prefecture: '広島県', city: '広島市' },
  四国: { prefecture: '愛媛県', city: '松山市' },
  '九州・沖縄': { prefecture: '福岡県', city: '福岡市' },
}

// 初期値（中部）
export const DEFAULT_REGION = {
  big: '中部' as const,
  prefecture: '愛知県' as const,
  city: '名古屋市' as const,
}

// 地域に応じたデフォルト値を取得
export function getDefaultRegionForArea(regionBig: keyof typeof REGIONS): { prefecture: string; city: string } {
  return REGION_DEFAULTS[regionBig] || DEFAULT_REGION
}
